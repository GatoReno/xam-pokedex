...
using System.Linq;
using System.Text;
using static Pokedex.Core.Models.PokemonDetailModel;
//PokemonDetail
namespace Pokedex.Core.Models
{
    public partial class PokemonDetailModel
    {
        public Ability Ability { get => Abilities?.FirstOrDefault(); }
    ...
    //crear otro vm para abilidades opcional
